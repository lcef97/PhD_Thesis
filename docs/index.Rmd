...
$$\eta_{it} := \boldsymbol{x_{it}}^\top \beta + z_{it}$$
  ...
  - $z_{it}$: spatio-temporal latent effect 
    ...
    - `R-INLA` codes [here](https://github.com/lcef97/CAV_Puglia/blob/main/CAV_output.R); 
    multivariate models [here](https://github.com/lcef97/CAV_Puglia/blob/main/Auxiliary/Functions.R)
...
## Chapter 4: Discussion
  ...
  - **Future** research directions:
    ...
    - Extend the **PC-prior** derivation in **multivariate** spatial models to **general** correlation or standard deviation matrices
