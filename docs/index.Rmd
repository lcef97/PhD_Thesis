...
Subject&#58; STAT/01-A, former SECS-S/01 - Statistics<br>
...
## Chapter 3: Spatial modelling of INVALSI data
  ...
  - Spatial modelling **municipality**-averaged **INVALSI** scores in **Italian and Mathematics** at the second year of high school in **2022/23**
  ...
  - **Sparse spatial structure** of INVALSI scores (most municipalities do not host a high school) $\Rightarrow$ spatial effects defined at the **province** level
...
$$
  ...
  - $\mathbf{L}:= \mathbf{D}-\mathbf{W}$: graph **Laplacian**,where $\mathbf{W}$ is the binary **neighbourhood** matrix ($w_{ij}=1$ if areas $i$ and $j$ are neighbours, $0$ otherwise) and $\mathbf{D}$ is the diagonal **degree** matrix ($d_i=\sum_j w_{ij}$, number of neighbours of node $i$)
...
## Chapter 4 Covariate effect posterior

  - **20** smoothest Laplacian eigenvectors removed from covariates **ELL** and **ER**; selection criterion: **WAIC**
...
$y =$ <span style="color: #C00005 ;">VAW **occurrence** </span> $\times$ <span style="color: #093C92 ;"> incidents **reporting** rate </span>
  ...
  - **TEP**: either relative <span style="color: #093C92 ;"> ease in reporting violence </span> in **proximity** of AVCs, or <span style="color: #C00005 ;"> **appropriateness** of AVC **placement** </span>
...
DT::datatable(cav_LCAR_hyper_post, 
...
## General conclusions
  ...
  - General empirical finding: **accessibility** to services matters and **peripheries** cannot be left behind

  - Future directions: **data integration** (incidence vs reporting), **multilevel/causal** extensions, and more work on multivariate PC-priors
