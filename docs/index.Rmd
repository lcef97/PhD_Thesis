...
## Chapter 2: INVALSI scores (Maths)
...
## Chapter 2: INVALSI scores (Italian)
...
$$
   ...
   - $x$: covariates;\quad $\beta$: covariate effects. For each subject, the first 3 covariates denote the **connected component** each site belongs to; first 3 covariate effects are **component-specific intercepts**
